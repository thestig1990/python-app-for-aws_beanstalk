...
<body id="sample">
  <div class="textColumn">
    ...
    <p style="color:yellow; font-size: 16px;">This environment is launched with Elastic Beanstalk Python Platform <br> from Jenkins using AWSEB Deployment plugin</p>
  </div>
